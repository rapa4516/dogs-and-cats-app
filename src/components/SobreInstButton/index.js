...
import logo from '../../assets/images/sobre-inst.png';
    ...
    return(
        <CustomModal visible={visible} onClose={onSobreInst}>
            ...
            <Container>
                ...
                >
                    <Text opacity={0.7} style={{ fontSize: 14, lineHeight: 17, textAlign: 'justify', marginBottom: 16}}>
                    {"\u00A0\u00A0\u00A0\u00A0\u00A0\u00A0\u00A0\u00A0"}
                    ...
                    <Image source={imagem} opacity={0.7} style={{
                    width: 275,
                    height: 175,
                    borderRadius: 3,
                    alignSelf: "center",
